...
SKILLS=['tsao-dft-researcher','tsao-structure-prep','tsao-periodic-dft-materials','tsao-dft-ml-active-learning','tsao-dft-hpc-provenance','tsao-dft-kinetics-multiscale','tsao-dft-catalysis-profile']
