...
The following SVGs are regenerated by [`scripts/generate_readme_demos.py`](scripts/generate_readme_demos.py) from fixed templates. Each is visibly labelled `SYNTHETIC DEMO · NOT SCIENTIFIC DATA`; none is a production calculation.
